...
async function prosesDataPesanan(orderData, headers, sellerId, urutanKe, namaPembeli) {
    ...
    try {
        ...
        const trackingNo = cariResiOtomatis(orderData) || "Dibatalkan / Tidak ada resi";
        ...
        // Pesanan batal biasanya data keuangannya 0 atau null, tapi tetap kita fetch jika ada
...
async function cekSemuaToko() {
    ...
    for (const store of stores) {
        ...
        // REFERER DISESUAIKAN UNTUK TAB DIBATALKAN (cancel)
        const headers = {
            "cookie": formattedCookie,
            "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/153.0.0.0 Safari/537.36",
            "content-type": "application/json",
            "origin": "https://seller-id.tokopedia.com",
            "referer": "https://seller-id.tokopedia.com/order?order_status[]=5&selected_sort=6&tab=cancel"
        };
        ...
        const chunkSize = 20; // Hajar 20 pesanan sekaligus!
        ...
        while (lanjutTarikHalaman) {
            ...
            // PAYLOAD BARU UNTUK STATUS "DIBATALKAN" (Tab 104)
            const payload = {
                ...
                search_condition: {
                    condition_list: {
                        search_tab: { value: ["104"] } // <-- DIUBAH KE 104
                    }
                },
                search_cursor: ""
            };
            ...
            try {
                ...
                if (data.code === 0) {
                    ...
                    if (orderList.length === 0) {
                        if (halamanKe === 1) console.log("Tidak ada pesanan berstatus Dibatalkan.\n");
        ...
        console.log(`✅ Selesai memeriksa ${store.nama_toko}. Total ditarik: ${totalPesananTokoIni} pesanan (Dibatalkan).\n`); 
    }
