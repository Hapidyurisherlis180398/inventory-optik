...
async function prosesDataPesanan(orderData, headers, sellerId, urutanKe, namaPembeli) {
    ...
    // PERBAIKAN: Parameter &settlement_status=1 DIHAPUS agar mencakup pesanan yang sudah cair
...
async function cekSemuaToko() {
    ...
    for (const store of stores) {
        ...
        const headers = {
            ...
            "referer": "https://seller-id.tokopedia.com/order?order_status[]=4&selected_sort=6&tab=completed"
        };
            ...
            try {
                ...
                if (data.code === 0) {
                    ...
                    if (orderList.length === 0) {
                        if (halamanKe === 1) console.log("Tidak ada pesanan berstatus Selesai.\n");
        ...
        console.log(`✅ Selesai memeriksa ${store.nama_toko}. Total ditarik: ${totalPesananTokoIni} pesanan (Selesai).\n`); 
    }
